...
def print_normalmode_with_fix_quantum(fname, imode, fixquantum, atoms, mass, q_eq, hessian):
    ...
    nmode = len(q_eq) - 6
    ampl = [0.0] * nmode
    energy = ww[imode]*(fixquantum + 0.5)
    ampl[imode] = math.sqrt(2.0 * energy) / ww[imode]

    print("mode: ",imode, "nvib: ",fixquantum,"amplitude: ", ampl[imode])
    print("energy [kcal/mol]: ",energy*627.51e0)
