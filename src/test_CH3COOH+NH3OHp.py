if __name__ == '__main__':
    ...
    CH3COOH  = Fragment.Polyatom_Init(fname='CH3COOH', qchem=qcinput_neutral, xyz=xyz_CH3COOH, random_rot=True)
    ...
    CH3COOH.Specify_Mode_Sampling(init_vib_type='ZPE', init_rot_type='Jfix', jrot=10)

    print("----------------------- CH3COOH --------------------")
    CH3COOH.print_mode_sampling()
    print("----------------------------------------------------\n")

    NH3OHp  = Fragment.Polyatom_Init(fname='NH3OHp', qchem=qcinput_positive, xyz=xyz_NH3OHp, random_rot=True)
    NH3OHp.Specify_Mode_Sampling(init_vib_type='ZPE', init_rot_type='Jfix', jrot=10)
    print("----------------------- NH3OHp --------------------")
    NH3OHp.print_mode_sampling()
    print("----------------------------------------------------")
    ...
    print("\nReaction of CH3-COOH + NH3-OH+\n")

    reaction =  Collision(CH3COOH, NH3OHp, qchem=qcinput_positive) 
