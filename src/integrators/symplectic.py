...
class Symplectic:
    ...
    def symplectic(self, qcinput, dt, wmass, q, p, atoms):
        """
    ...
    def initialize_symplectic(self):
        """
        ...
        if self.order == 4:
            ...
            self.dd = [wi[6], wi[5], wi[4], wi[3], wi[2], wi[1], wi[0],
                       wi[7], wi[0], wi[1], wi[2], wi[3], wi[4], wi[5], wi[6]]
            ...
            raise ValueError("Wrong order in Symplectic! Only order = 4,6,8 is avialable")
