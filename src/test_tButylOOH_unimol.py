if __name__ == '__main__':
    ...
    'charge': 0,
    'multiplicity': 2,
    'additional': '--iterations 200 --spinpol --tblite',
    'wfu': False
    }
    ...
    QOOH  = Fragment.Polyatom_Init(fname='TBOOH', qchem=qcinput_XTB, xyz=xyz, random_rot=False)
   ...
   #diene.Specify_Mode_Sampling(init_vib_type='ZPE', init_rot_type='Jfix', jrot=10, fix_quantum=fix_quantum, fix_temp=fix_temp)
    ...
    QOOH.sample_and_run_trajectory(traj_file='TBOOH_OH-exc_exc_2OH.xyz',integrator='leapfrog', integrator_order=4, timestep=1.0, maxstep=3000, iprint=1, Rstop=10.0, spectrum=True) 
