...
if __name__ == "__main__":
    ...
    # REACTION_MODE controls only the Baker TS search after the RDA or
    # poormans_NEB guess.
...
Conf: 12
  ...
  H   -1.52641642165359     -1.67824256883544      2.55882854360463
    ...
    qcinput_orca_doublet = {
        ...
        "additional": "",
        "wfu": False,
        "scratch_dir": "scratch/IsoPOO_epoxide_TS_4_5_radical_poormans_NEB_RDA",
    }
    ...
    print("IsoPOO epoxide TS-4-5 radical poormans_NEB RDA + Baker TS optimization")
    ...
    result = optimize_transition_state(
        ...
        settings=OptimizerConfig.from_dict({
            ...
            "hessian": {
                "hess_file": "hessian_IsoPOO_epoxide_poormans_NEB_RDA_TS_4_5_radical.hess",
            ...
            "reporting": {
                "trajectory_file": "tsopt_IsoPOO_epoxide_poormans_NEB_RDA_TS_4_5_radical_Orca.xyz",
            },
            "project_eckart": True,
        }),
    )
    ...
    print("Starting frequency analysis for IsoPOO epoxide poormans_NEB RDA TS-4-5 radical", flush=True)
    frequency_analysis(
        qcinput=qcinp,
        atoms=result.atoms,
        q=result.q,
        fname="IsoPOO_epoxide_poormans_NEB_RDA_TS_4_5_radical",
        hessFile="hessian_IsoPOO_epoxide_poormans_NEB_RDA_TS_4_5_radical_final_freq.hess",
        is_eckart=True,
    ...
    print("Finished frequency analysis for IsoPOO epoxide poormans_NEB RDA TS-4-5 radical", flush=True)
