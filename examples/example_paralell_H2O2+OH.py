...
if __name__ == '__main__':
    ...
    reaction =  Collision(H2O2, OH, qchem=qcinput_PySCF) 
    reaction.Specify_Collision_Sampling(Rini=3.5, bmax=2.0, bsampling=True, Ecoll_thermal=True, temp=300.0)

    reaction.paralell_traj_sample_and_run_collision(total_trajectories=4, nparallel_jobs=4, nproc_per_job=1, progress_mode='table', slurm=False, integrator='leapfrog', integrator_order=4, timestep=0.7, maxstep=10000, iprint=1, pairs_to_stop=pairs_to_test)
