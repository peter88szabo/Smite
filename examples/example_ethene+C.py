...
if __name__ == '__main__':
    ...
    for FSSDH see this too:
    Cite this: J. Phys. Chem. A 2018, 122, 14, 3556–3562
    https://doi.org/10.1021/acs.jpca.8b01386
    '''
    xyz_ethene = '''
    ...
    print("\nReaction of Ethene + C(3P)\n")

    reaction = Collision(ethene, carbon, qchem=qcinput_triplet) 
