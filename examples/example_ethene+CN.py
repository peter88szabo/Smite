...
if __name__ == '__main__':
    ...
    #XTB opt
    req_CN = 1.13587 #Angstrom
    omega_CN = 2369.59 #cm-1

    CN = Fragment.Diatom_Init(fname='CN', atoms=['C','N'], req=req_CN, omega=omega_CN, random_rot=True, diatom='harmonic')
    #OH.Specify_Mode_Sampling(init_rot_type='Jfix', nvib=0, jrot=0)
    CN.Specify_Mode_Sampling(init_rot_type='Temp', nvib=0, temp=300.0)
    ...
    print("\nReaction of Ethene + CN\n")

    reaction = Collision(ethene, CN, qchem=qcinput_doublet) 
