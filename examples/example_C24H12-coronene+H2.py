...
H            1.84733040367093        5.68965953045204       -1.13705408554768
    ...
    H2.Specify_Mode_Sampling(init_rot_type='Jfix', nvib=0, jrot=4.0)
    ...
    reaction.Specify_Collision_Sampling(Rini=9.0, bmax=2.0, bsampling=True, Ecoll_thermal=True, temp=100.0, surf_skew_max=20.0, surf_skew_fix=20.0, surf_side=1)

    reaction.sample_and_run_collision(integrator='leapfrog', integrator_order=4, timestep=0.5, maxstep=10000, iprint=20, pairs_to_stop=pairs_to_test)
