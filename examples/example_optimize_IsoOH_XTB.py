...
if __name__ == "__main__":
    ...
    qcinput_xtb_doublet = {
        ...
        "wfu": False,
        "hessian_dx": 0.001,
        "scratch_dir": "scratch/IsoOH_XTB_geomopt",
    }
    ...
    result = optimize_geometry(
        ...
        settings=OptimizerConfig.from_dict({
            ...
            "reporting": {
                "trajectory_file": "geomopt_IsoOH_XTB.xyz",
            },
        }),
    )

    print("IsoOH radical optimization with XTB")
    print("charge:", qcinput_xtb_doublet["charge"])
    print("multiplicity:", qcinput_xtb_doublet["multiplicity"])
    ...
    frequency_analysis(
        qcinput=qcinput_xtb_doublet,
        atoms=result.atoms,
        q=result.q,
        fname="IsoOH_XTB",
        hessFile="hessian_IsoOH_XTB.hess",
        is_eckart=True,
