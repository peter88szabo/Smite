...
contains
   ...
   subroutine clch4_init() bind(C, name="clch4_init")
      call initialize_potential()
   end subroutine clch4_init

   subroutine clch4_energy_gradient(q_bohr, natoms_in, energy, gradient, info) bind(C, name="clch4_energy_gradient")
      ...
      real(c_double) :: q(3, 6, 1)
      real(c_double) :: v(1)
      real(c_double) :: dvdq(3, 6, 1)
      integer :: i, j
   ...
   end subroutine clch4_energy_gradient

end module clch4_c_interface
